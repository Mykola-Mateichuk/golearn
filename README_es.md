...
Este proyecto ha sido creado con fines de aprendizaje.

Contendrá todos los trabajos de tareas domésticas y también algunas funciones relacionadas con la prueba de materiales teóricos.

El proyecto contiene el paquete hasher. Contiene dos funciones: ** HashPassword ** y ** CheckPasswordHash **.

Lea más sobre el paquete hasher en el archivo hasher / README.md.
